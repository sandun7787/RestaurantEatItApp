...
public class classiccupcakeAdapter extends ArrayAdapter<classiccupcakeClass> {
    ...
    public classiccupcakeAdapter(Activity context, ArrayList<classiccupcakeClass> i_food) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        classiccupcakeClass currenti_food = getItem(position);
